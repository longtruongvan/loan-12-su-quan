...
public class cr extends ae {
  ...
  private void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    ...
    bz.c.a(paramGraphics, String.valueOf(u.a(this.v.a)), paramInt1 + 40, paramInt2 + 0, 0);
    j2me.y.a(paramGraphics, this.z, 0, this.C, this.B, this.C, paramInt1 + 40, paramInt2 + 15, 0);
    j2me.y.a(paramGraphics, this.z, 0, 0, this.B * this.v.c / this.v.b, this.C, paramInt1 + 40, paramInt2 + 15, 0);
    ...
    j2me.y.a(paramGraphics, this.y, 0, this.C, this.B, this.C, paramInt1 + 40, paramInt2 + 28, 0);
    j2me.y.a(paramGraphics, this.y, 0, 0, this.B * (this.w - this.F) / (this.E - this.F), this.C, paramInt1 + 40,
        paramInt2 + 28, 0);
  ...
  private void b(Graphics paramGraphics, int paramInt1, int paramInt2) {
    if (dd.a < 0) {
      ...
      if (this.N) {
        ...
        bz.c.a(paramGraphics, String.valueOf(this.H), paramInt1 + 160, paramInt2 + 21, 2);
      } else {
        bz.d.a(paramGraphics, "-Thu thập", paramInt1 + 4, paramInt2 + 21, 0);
        bz.c.a(paramGraphics, String.valueOf(this.G), paramInt1 + 160, paramInt2 + 21, 2);
      }
      ...
      if (this.N) {
        ...
        bz.c.a(paramGraphics, String.valueOf(this.J), paramInt1 + 160, paramInt2 + 70, 2);
      } else {
        bz.d.a(paramGraphics, "-Thu thập", paramInt1 + 4, paramInt2 + 70, 0);
        bz.c.a(paramGraphics, String.valueOf(this.K), paramInt1 + 160, paramInt2 + 70, 2);
        bz.d.a(paramGraphics, "-Thắng trận", paramInt1 + 4, paramInt2 + 85, 0);
        bz.c.a(paramGraphics, String.valueOf(this.I), paramInt1 + 160, paramInt2 + 85, 2);
      }
    } else {
      ...
      bz.c.a(paramGraphics, String.valueOf(this.K), paramInt1 + 160, paramInt2 + 21, 2);
    }
  }

  public void a(Graphics paramGraphics) {
    j2me.cz.a(paramGraphics, cx.P, cx.Q, this.g, this.a_, this.b_, this.c_);
