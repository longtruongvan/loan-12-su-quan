...
public class az {
  ...
  private static Image c(String paramString) {
    ...
    try {
      String assetPath = paramString.startsWith("/") ? paramString.substring(1) : paramString;
      InputStream inputStream = javax.microedition.midlet.MIDlet.getActivity().getAssets().open(assetPath);
