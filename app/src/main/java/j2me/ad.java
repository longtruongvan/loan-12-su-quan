...
public class ad extends ae {
  ...
  private void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    ...
    com.mic.smsgame.suquan.u.a(paramGraphics, this.u.a, paramInt1 + 4, paramInt2 + 4, true);
    bz.c.a(paramGraphics, com.mic.smsgame.suquan.u.a(this.u.a), paramInt1 + 40, paramInt2 + 0, 0);
    j2me.y.a(paramGraphics, this.y, 0, this.B, this.A, this.B, paramInt1 + 40, paramInt2 + 15, 0);
    j2me.y.a(paramGraphics, this.y, 0, 0, this.A * this.u.c / this.u.b, this.B, paramInt1 + 40, paramInt2 + 15, 0);
    ...
    j2me.y.a(paramGraphics, this.x, 0, this.B, this.A, this.B, paramInt1 + 40, paramInt2 + 28, 0);
    j2me.y.a(paramGraphics, this.x, 0, 0, this.A * (this.v - this.E) / (this.D - this.E), this.B, paramInt1 + 40, paramInt2 + 28, 0);
