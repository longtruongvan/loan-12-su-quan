...
public class co {
  ...
  private void b(int paramInt) {
    ...
    this.y = com.mic.smsgame.suquan.u.a(this.g[paramInt]);
  }
  ...
  private void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    com.mic.smsgame.suquan.u.a(paramGraphics, this.s.a, paramInt1 + 10, paramInt2 + 3, true);
  ...
  public void a(Graphics paramGraphics) {
    ...
    for (j = 0; j < this.g.length; j++) {
      if (this.z[j]) {
        j2me.y.a(paramGraphics, this.m, j * this.n, 0, this.n, this.o, i, this.d + 30, 0);
    ...
    if (this.j >= 0) {
      ...
      j2me.y.a(paramGraphics, this.m, this.j * this.n, 0, this.n, this.o, j, this.d + 30, 0);
