...
public class i extends dq {
  ...
  public void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    if (this.c == 5) {
      int j = this.p - this.v / 2;
      int k = this.q - this.v / 2;
      j2me.y.a(paramGraphics, j2me.y.d);
      j2me.y.a(paramGraphics, j2me.y.d, j, k, this.v, this.v);
      super.a(paramGraphics, paramInt1, paramInt2);
      j2me.y.b(paramGraphics, j2me.y.d);
    } else {
      if (this.B && this.c == 1) {
        paramInt1 += this.z;
        paramInt2 += this.A;
...
/*
 * Location:
 * C:\Users\bot-nosense\Downloads\Loan-12-Su-Quan.jar!\com\mic\smsgame\suquan\i.
 * class
