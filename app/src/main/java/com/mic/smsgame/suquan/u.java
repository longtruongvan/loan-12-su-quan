...
public class u {
  public static void a(Graphics paramGraphics, int paramInt1, int paramInt2, int paramInt3, int paramInt4,
    ...
    paramGraphics.drawRegion(paramArrayOfImage[0], 0, 0, paramArrayOfImage[0].getWidth(),
        paramArrayOfImage[0].getHeight(), 1, paramInt1, paramInt2 + paramInt3, 36);
  ...
  public static void a(Graphics g, int a, int b, int c, boolean d) {
    // Stub
  }
...
/*
 * Location:
 * C:\Users\bot-nosense\Downloads\Loan-12-Su-Quan.jar!\com\mic\smsgame\suqua\\u.
 * class
